                ...
                {isLogin && (
                  <div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center px-3 py-2 text-base font-medium text-gray-100 hover:bg-red-500  bg-red-400 rounded cursor-pointer"
