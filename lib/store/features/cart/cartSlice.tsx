...
export const cartSlice = createSlice({
    ...
    initialState,
    reducers:{
        addCart:(state,action:PayloadAction<{productId:number,quantity:number}>)=>{
...
export const {addCart,clearCart,removeCartProduct,removeProductQuantity} = cartSlice.actions
